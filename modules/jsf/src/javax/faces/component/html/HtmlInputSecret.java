...
public class HtmlInputSecret extends UIInput
{
  ...
  public Object saveState(FacesContext context)
  {
    ...
    return new Object[] {
      ...
      _autocomplete,
      Util.save(_autocompleteExpr, context),
      _dir,
      ...
      _maxlength,
      Util.save(_maxlengthExpr, context),
      ...
      _redisplay,
      Util.save(_redisplayExpr, context),
      _size,
      Util.save(_sizeExpr, context),
      _style,
  ...
  public void restoreState(FacesContext context, Object value)
  {
    ...
    _autocompleteExpr = Util.restoreString(state[i++], context);
    ...
    _maxlengthExpr = Util.restoreInt(state[i++], context);
    ...
    _redisplayExpr = Util.restoreBoolean(state[i++], context);

    _size = (Integer) state[i++];
    _sizeExpr = Util.restoreInt(state[i++], context);
