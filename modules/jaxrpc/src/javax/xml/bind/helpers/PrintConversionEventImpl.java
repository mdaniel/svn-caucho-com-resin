...
/**
 * Default implementation of the PrintConversionEvent interface. JAXB providers
 ...
 * Also:PrintConversionEvent, Validator, ValidationEventHandler,
...
public class PrintConversionEventImpl extends ValidationEventImpl implements PrintConversionEvent {
  ...
  /**
   * Create a new PrintConversionEventImpl. Parameters:_severity - The severity
