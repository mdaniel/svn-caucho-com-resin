 ...
 * marshal operation that the provider is unable to recover from. The
 * ValidationEventHandler can cause this exception to be thrown during the
 * marshal operations. See ValidationEventHandler.handleEvent(ValidationEvent).
 * Since: JAXB1.0 Version: $Revision: 1.1 $ Author: Ryan Shoemaker, Sun
 * Microsystems, Inc. See Also:JAXBException, Marshaller, Serialized Form
 */
