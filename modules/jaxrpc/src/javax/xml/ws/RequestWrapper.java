 ...
 * targetNamespace is the target namespace of the SEI. When starting from Java
 * this annotation is used resolve overloading conflicts in document literal
 * mode. Only the className is required in this case. Since: JAX-WS 2.0 See
 * Also:WebMethod
 */
