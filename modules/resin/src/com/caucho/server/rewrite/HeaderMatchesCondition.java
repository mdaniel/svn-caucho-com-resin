...
/**
 * A rewrite condition that passes if a named header has a value
 * that matches a regular expression.  If a header does not exist,
 * it has a value of "" (empty string) for purposes of comparison
 * to the regular expression pattern.
 */
public class HeaderMatchesCondition
  extends AbstractMatchesCondition
{
  ...
  /**
   * Sets the name of the header, required.
   */
