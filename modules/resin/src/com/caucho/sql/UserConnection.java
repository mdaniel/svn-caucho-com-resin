...
public class UserConnection implements java.sql.Connection {
    ...
    throws SQLException
  {
    ...
    try {
      // XXX: locking issue: getDriverConnection().prepareStatement(this, sql, autoGeneratedKeys);
      ...
      if (_statement == null)
        ...
        conn = _statement.getConnection();

        if (conn.getAutoCommit())
          conn = getDriverConnection();

        // XXX: else uses same connection to avoid locking issue.
      }
    ...
    throws SQLException
  {
    ...
    try {
      // XXX: locking issue. getMConn().prepareStatement(this, sql, autoGeneratedKeys);
      ...
      if (_statement == null)
        ...
        // XXX: else uses same connection to avoid locking issues.
      }
