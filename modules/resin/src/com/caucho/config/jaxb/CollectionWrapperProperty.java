...
public class CollectionWrapperProperty extends JaxbProperty {
  private CollectionWrapperType _wrapperType
    = new CollectionWrapperType();
  
  public CollectionWrapperProperty()
  {
  }

  public HashMap<String,AttributeStrategy> getAttributeMap()
  {
