...
public class DoubleProperty extends JaxbProperty {
  private final Method _method;
  
  public DoubleProperty(Method method)
  {
    _method = method;
  }
    ...
    throws ConfigException
  {
    ...
    double value = builder.evalDouble(textValue);

    try {
      _method.invoke(bean, new Double((double) value));
