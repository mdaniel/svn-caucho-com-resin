...
public class ShortProperty extends JaxbProperty {
  private final Method _method;
  
  public ShortProperty(Method method)
  {
    _method = method;
  }
    ...
    throws ConfigException
  {
    ...
    long value = evalLong(builder, textValue);

    try {
      _method.invoke(bean, new Short((short) value));
