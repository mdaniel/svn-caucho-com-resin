 ...
 */
public class BooleanType extends TypeStrategy {
  protected static final L10N L = new L10N(BooleanType.class);
    ...
    throws ConfigException
  {
    ...
    if (textValue.indexOf("${") >= 0)
      return builder.evalBoolean(textValue) ? Boolean.TRUE : Boolean.FALSE;
