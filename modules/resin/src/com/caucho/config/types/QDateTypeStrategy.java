...
public class QDateTypeStrategy extends TypeStrategy {
  protected static final L10N L = new L10N(QDateTypeStrategy.class);
  ...
  public Object configure(NodeBuilder builder, Node node, Object parent)
    throws Exception
  {
    String dateString = builder.configureString(node);

    return parseDate(dateString);
  }

  public static QDate parseDate(String dateString)
    throws Exception
  {
