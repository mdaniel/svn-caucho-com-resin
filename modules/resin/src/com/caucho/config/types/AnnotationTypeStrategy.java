...
public class AnnotationTypeStrategy extends TypeStrategy {
  protected static final L10N L = new L10N(AnnotationTypeStrategy.class);
  ...
  public Object configure(NodeBuilder builder, Node node, Object parent)
    throws Exception
  {
    String signature = builder.configureRawString(node);

    return parseAnnotation(signature);
  }
