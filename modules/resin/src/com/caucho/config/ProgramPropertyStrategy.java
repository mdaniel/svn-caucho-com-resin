 ...
 */
public class ProgramPropertyStrategy extends AttributeStrategy {
  static L10N L = new L10N(ProgramPropertyStrategy.class);

  private final Method _setter;
  private String _name;
  
  public ProgramPropertyStrategy(Method setter)
