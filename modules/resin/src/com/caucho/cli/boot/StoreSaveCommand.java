...
public class StoreSaveCommand extends ManagementCommandBase
{
                            ...
                            ManagerClientApi managerClient)
  {
    ...
    String result = managerClient.doStoreDump(name + ":" + context);
    ...
    try (WriteStream out = Vfs.lookup(fileName).openWrite()) {
      out.print(result);
