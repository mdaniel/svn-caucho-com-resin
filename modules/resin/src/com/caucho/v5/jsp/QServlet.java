...
abstract public class QServlet implements Servlet {
  ...
  public void init(ServletConfig config) throws ServletException
  {
    ...
    log.finest("init " + config.getServletName());
  }
  ...
  private Page getSubPage(HttpServletRequest req, HttpServletResponse res)
    throws Exception
  {
    RequestCaucho cauchoRequest = null;
    ...
    */
    ...
    if (req instanceof RequestCaucho)
      cauchoRequest = (RequestCaucho) req;
