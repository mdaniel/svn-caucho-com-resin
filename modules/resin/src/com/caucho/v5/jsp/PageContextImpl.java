...
import com.caucho.v5.jsp.el.PageContextAttributeMap;
import com.caucho.v5.jsp.el.PageContextELResolver;
...
public class PageContextImpl extends PageContext
  ...
  private ResponseAdapterToChar _responseAdapter;
                         ...
                         boolean autoFlush)
  {
    ...
    WebAppResin app = (WebAppResin) request.getServletContext();
                         ...
                         boolean isPrintNullAsBlank)
  {
    ...
    if ((response instanceof ResponseAdapterToChar)
      ...
      _responseAdapter = ResponseAdapterToChar.create((HttpServletResponse) response);
   ...
   */
  public WebAppResin getApplication()
  {
    return _webApp;
  }
  ...
  public ELContext getELContext()
  {
    ...
    if (_elContextValue == null) {
      WebAppResin webApp = getApplication();
  ...
  public void release()
  {
    try {
      ...
      */
      ...
      ResponseAdapterToChar resAdapt = _responseAdapter;
      _responseAdapter = null;
      ...
      if (resAdapt != null) {
        ...
        ResponseAdapterToChar.free(resAdapt);
      }
    ...
    public Object getValue(String name)
    {
      ...
      if (prefix.equals("param"))
        ...
        if (request instanceof RequestCaucho)
          cookie = ((RequestCaucho) request).getCookie(suffix);
        else
          cookie = null;
  ...
  public class PageFunctionMapper extends javax.el.FunctionMapper 
  {
    ...
    public Method resolveFunction(String prefix, String localName)
    {
      if (_functionMap != null)
        return _functionMap.get(String.format("%s:%s", prefix, localName));
      else
        return null;
    }
    ...
    {
      _functionMap.put(String.format("%s:%s", prefix, localName), method);
    }
  }
