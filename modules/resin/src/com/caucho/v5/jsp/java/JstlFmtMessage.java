...
public class JstlFmtMessage extends JstlNode {
    ...
    throws Exception
  {
    ...
    if (_key != null) {
      ...
      out.println("String " + keyExpr + " = ((com.caucho.v5.jsp.BodyContentImpl) out).getTrimString();");
    ...
    if (_params.size() > 0) {
      ...
      for (int i = 0; i < _params.size(); i++) {
        ...
        if (! value.equals("")) {
          ...
          out.println(paramVar + "[" + i + "] = ((com.caucho.v5.jsp.BodyContentImpl) out).getTrimString();");
