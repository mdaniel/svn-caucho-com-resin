...
import com.caucho.v5.jsp.JspGenerator;
import com.caucho.v5.jsp.JspPageConfig;
import com.caucho.v5.jsp.JspParseException;
import com.caucho.v5.jsp.PageContextImpl;
import com.caucho.v5.jsp.ParseState;
import com.caucho.v5.jsp.ParseTagManager;
import com.caucho.v5.jsp.QPageData;
import com.caucho.v5.jsp.StaticPage;
import com.caucho.v5.jsp.TagInstance;
import com.caucho.v5.jsp.Taglib;
...
public class JavaJspGenerator extends JspGenerator {
  ...
  {
    if ("com.caucho.v5.jsp.java.JspTagFileSupport".equals(cl))
  ...
  void mapFunction(String prefix, String localName, Method method)
  {
    if (prefix == null || prefix.isEmpty())
      _elFunctionMap.put(localName, method);
    else
      _elFunctionMap.put(prefix + ":" + localName, method);
  }
    ...
    throws JspParseException
  {
    ...
    for (int i = 0; i < functions.size(); i++) {
      ...
      mapFunction(taglib.getPrefixString(), 
                  function.getName(), 
                  function.getMethod());
    }
  }
  ...
  {
    out.println("/*");
    out.println(" * JSP generated by " + Version.getFullVersion());
    out.println(" */" );
    out.println();
    ...
    if (_parseState.getExtends() != null) {
      ...
      out.print(" implements com.caucho.v5.jsp.CauchoPage");
      if (! _parseState.isThreadSafe())
        out.print(", javax.servlet.SingleThreadModel");
    } else {
      out.print("public class ");
      out.print(_className);
      out.print(" extends com.caucho.v5.jsp.JavaPage");
      if (! _parseState.isThreadSafe())
    ...
    out.println("private com.caucho.v5.jsp.PageManager _jsp_pageManager;");
    //out.println("private com.caucho.v5.util.FreeList<TagState> _jsp_freeState = new com.caucho.v5.util.FreeList<TagState>(8);");
  ...
  protected void generatePageHeader(JspJavaWriter out) throws Exception
  {
    ...
    out.println("_jspService(javax.servlet.http.HttpServletRequest request,");
    out.println("            javax.servlet.http.HttpServletResponse response,");
    out.println("            com.caucho.v5.jsp.PageContextImpl pageContext,");
    ...
    if (_parseState.isErrorPage()) {
      out.println("java.lang.Throwable exception = ((com.caucho.v5.jsp.PageContextImpl) pageContext).getThrowable();");
    }
    out.println("javax.servlet.jsp.tagext.JspTag _jsp_parent_tag = null;");
    out.println("com.caucho.v5.jsp.PageContextImpl _jsp_parentContext = pageContext;");
  ...
  Class<?> loadBeanClass(String typeName)
  {
    ...
    try {
      return CauchoUtil.loadClass(typeName);
    } catch (CompileClassNotFound e) {
      log.log(Level.FINE, e.toString(), e);
    } catch (ClassNotFoundException e) {
    }
    ...
    for (int i = 0; i < imports.size(); i++) {
      ...
      try {
        return CauchoUtil.loadClass(fullName);
      } catch (CompileClassNotFound e) {
        log.log(Level.WARNING, e.toString(), e);
      } catch (ClassNotFoundException e) {
      }
...
*/
    ...
    throws Exception
  {
    ...
    out.println("                               TagState _jsp_state,");
    out.println("                               com.caucho.v5.jsp.PageManager _jsp_pageManager)");
    out.println("{");
    out.pushDepth();
    ...
    out.println("public class _CauchoFragment_" + id + " extends com.caucho.v5.jsp.JspFragmentSupport {");
    out.pushDepth();
...
//  out.println("private void " + frag.getFragmentName() + "(JspWriter out)");
  ...
  private void generateDepends(JspJavaWriter out) throws IOException
  {
    ...
    out.println();
    out.println("public java.util.ArrayList<com.caucho.v5.vfs.Dependency> _caucho_getDependList()");
    out.println("{");
    out.println("  return _caucho_depends.getDependencies();");
    out.println("}");

    out.println();
    out.println("public void _caucho_addDepend(com.caucho.v5.vfs.PersistentDependency depend)");
    out.println("{");
    out.pushDepth();

    if (_parseState.getExtends() == null)
      out.println("super._caucho_addDepend(depend);");
    // out.println("  com.caucho.v5.jsp.JavaPage.addDepend(_caucho_depends, depend);");
    ...
    out.println();
    out.println("if (" + CauchoUtil.class.getName() + ".getVersionId() != " +
                CauchoUtil.getVersionId() + "L)");
    out.println("  return true;");
    ...
    if (_alwaysModified)
      ...
      out.pushDepth();
      out.println("com.caucho.v5.vfs.Dependency depend;");
      out.println("depend = (com.caucho.v5.vfs.Dependency) _caucho_depends.get(i);");
    ...
    if (_rootNode.isStatic() && CauchoUtil.isTest())
      out.println("private static long _caucho_lastModified = com.caucho.v5.util.CurrentTime.getCurrentTime();");
    ...
    if (! _isCacheable || _isUncacheable)
      ...
      out.println("return com.caucho.v5.jsp.Page.calculateLastModified(_caucho_depends, _caucho_cacheDepends);");
    }
    */
    ...
    if (! isGenerateStatic()) {
      ...
      out.println("if (oDepend instanceof com.caucho.v5.vfs.Depend) {");
      out.println("  com.caucho.v5.vfs.Depend depend = (com.caucho.v5.vfs.Depend) oDepend;");
    ...
    */
    ...
    String webAppClass = WebAppResin.class.getName();

    if (_parseState.getExtends() != null && ! _parseState.isTag()) {
      out.println();
      out.println("public " + webAppClass + " _caucho_getApplication()");
      out.println("{");
      out.pushDepth();
      out.println(" return (" + webAppClass + ") getServletConfig().getServletContext();");
      out.popDepth();
      out.println("}");
    }
    ...
    throws IOException
  {
    ...
    out.println(webAppClass + " webApp");
    out.println("  = (" + webAppClass + ") config.getServletContext();");

    if (! isTag()) {
      out.println("init(config);");
    }

    out.println("if (com.caucho.v5.jsp.JspManager.getCheckInterval() >= 0)");
    out.println("  _caucho_depends.setCheckInterval(com.caucho.v5.jsp.JspManager.getCheckInterval());");

    out.println("_jsp_pageManager = webApp.getJspApplicationContext().getPageManager();");

    out.println("com.caucho.v5.jsp.TaglibManager manager = webApp.getJspApplicationContext().getTaglibManager();");
    ...
    if (! isTag())
      out.println("com.caucho.v5.jsp.PageContextImpl pageContext = new com.caucho.v5.jsp.InitPageContextImpl(webApp, this);");
    else
      out.println("com.caucho.v5.jsp.PageContextImpl pageContext = new com.caucho.v5.jsp.InitPageContextImpl(webApp, _caucho_getFunctionMap());");

    for (int i = 0; i < _exprList.size(); i++) {
      String expr = _exprList.get(i);

      out.print("_caucho_expr_" + i + " = com.caucho.v5.jsp.JspUtil.createExpr(pageContext.getELContext(), \"");
    ...
    for (int i = 0; i < _valueExprList.size(); i++) {
      ...
      out.print("_caucho_value_expr_" + i + " = com.caucho.v5.jsp.JspUtil.createValueExpression(pageContext.getELContext(), ");
    ...
    for (int i = 0; i < _methodExprList.size(); i++) {
      ...
      out.print("_caucho_method_expr_" + i + " = com.caucho.v5.jsp.JspUtil.createMethodExpression(pageContext.getELContext(), \"");
    ...
    out.popDepth();
    out.println("} catch (Exception e) {");
    out.println("  throw com.caucho.v5.config.ConfigException.create(e);");
    out.println("}");
  ...
  {
    out.println();
    out.println("public void init(com.caucho.v5.vfs.Path appDir)");
    ...
    out.println(DynamicClassLoader.class.getName() + " loader;");
    out.println("loader = (" + DynamicClassLoader.class.getName() + ") getClass().getClassLoader();");
    ...
    */
    ...
    for (int i = 0; i < depends.size(); i++) {
      ...
      if (dependency instanceof Depend) {
        ...
        out.print("depend = new com.caucho.v5.vfs.Depend(");
        ...
        /*
        out.print("com.caucho.v5.jsp.JavaPage.addDepend(_caucho_depends, ");
    ...
    throws IOException
  {
    ...
    if (tag.getAnalyzedTag() != null
      ...
      out.println("private static com.caucho.v5.config.j2ee.InjectProgram _jsp_inject_" + tag.getId() + ";");
    }*/
  ...
  {/*
    if (tag.getAnalyzedTag() != null
      ...
      out.println("com.caucho.v5.config.inject.InjectManager.create().getReference("
