...
import com.caucho.v5.jsp.JspParser;
...
public abstract class JspNode {
    ...
    throws Exception
  {
    ...
    if (objValue instanceof JspFragmentNode)
      ...
      out.print("new com.caucho.v5.jsp.ELExprFragment(pageContext, _caucho_expr_" + index + ")");
    }
    else {
    ...
    throws Exception
  {
    ...
    return ("new com.caucho.v5.jsp.ELExprFragment(pageContext, _caucho_expr_" + index + ")");
  }
    ...
    throws Exception
  {
    ...
    if (frag.isStatic()) {
      ...
      cb.append(fragmentVar + " = com.caucho.v5.jsp.StaticJspFragmentSupport.create(" + fragmentVar + ", " + contextVar + ", \"");
  ...
  {
    if (boolean.class.equals(type))
      return PageContextImpl.class.getName() + ".toBoolean(" + obj + ")";
    else if (Boolean.class.equals(type))
