...
public class JstlCoreForEach extends JstlNode {
    ...
    throws Exception
  {
    ...
    if (_tag != null) {
      ...
      if (isInteger())
        out.println("com.caucho.v5.jsp.IntegerLoopSupportTag " + _tagVar + " = null;");
      else
        out.println("com.caucho.v5.jsp.IteratorLoopSupportTag " + _tagVar + " = null;");
    }
    ...
    throws Exception
  {
    ...
    if (_items == null && _itemsAttr == null)
      tagClass = "com.caucho.v5.jsp.IntegerLoopSupportTag";
    else
      tagClass = "com.caucho.v5.jsp.IteratorLoopSupportTag";
