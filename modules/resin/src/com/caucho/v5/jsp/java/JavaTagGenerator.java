...
import com.caucho.v5.jsp.TempTagInfo;
import com.caucho.v5.jsp.cfg.TldAttribute;
import com.caucho.v5.jsp.cfg.TldTag;
...
public class JavaTagGenerator extends JavaJspGenerator {
  ...
  */
  ...
  {
    out.println("/*");
    out.println(" * JSP-Tag generated by " + Version.getFullVersion());
    out.println(" */" );
    out.println();
    ...
    if (hasScripting())
      out.print(" extends com.caucho.v5.jsp.java.JspTagSupport");
    else
      out.print(" extends com.caucho.v5.jsp.java.JspTagFileSupport");
    ...
    // jsp/107{0,1}
    out.println("private static com.caucho.v5.jsp.PageManager _jsp_pageManager;");
    ...
    throws Exception
  {
    ...
    out.println("com.caucho.v5.jsp.PageContextWrapper pageContext = _jsp_pageManager.createPageContextWrapper(_jsp_parentContext);");
    // jsp/1056
    ...
    out.println("com.caucho.v5.jsp.PageContextWrapper jspContext = pageContext;");
    ...
    out.println("  throw com.caucho.v5.jsp.QJspException.createJspException(e);");
    out.println("}");
    ...
    throws Exception
  {
    ...
    out.println("                         com.caucho.v5.jsp.PageContextWrapper pageContext,");
    ...
    throws IOException, JspParseException
  {
    ...
    out.println("  throws com.caucho.v5.config.ConfigException");
    out.println("{");
    out.pushDepth();
    ...
    */
    ...
    out.println("{");
    out.pushDepth();
    out.println("com.caucho.v5.jsp.cfg.TldTag tag = new com.caucho.v5.jsp.cfg.TldTag();");

    out.println("tag.setName(\"test\");");

    out.println("com.caucho.v5.jsp.cfg.TldAttribute attr;");
    for (int i = 0; i < _attributes.size(); i++) {
      TldAttribute attr = _attributes.get(i);

      out.println("attr = new com.caucho.v5.jsp.cfg.TldAttribute();");
      ...
      if (attr.getDeferredValue() != null) {
        out.println("attr.setDeferredValue(new com.caucho.v5.jsp.cfg.TldAttribute.DeferredValue());");
      ...
      if (attr.getDeferredMethod() != null) {
        out.println("attr.setDeferredMethod(new com.caucho.v5.jsp.cfg.TldAttribute.DeferredMethod());");

        Signature sig = attr.getDeferredMethod().getMethodSignature();

        if (sig != null) {
          out.print("attr.getDeferredMethod().setMethodSignature(");
          out.print("new com.caucho.v5.config.types.Signature(\"");
    ...
    out.println("com.caucho.v5.jsp.cfg.TldVariable var;");
    for (int i = 0; i < _variables.size(); i++) {
      TldVariable var = _variables.get(i);

      out.println("var = new com.caucho.v5.jsp.cfg.TldVariable();");
    ...
    out.println("return new com.caucho.v5.jsp.java.TagInfoExt(tag.getName(),");
    ...
    throws IOException, JspParseException
  {
    ...
    out.println("return new com.caucho.v5.jsp.java.TagTaglib(\"x\", \"http://test.com\");");
    out.popDepth();
    out.println("}");
  }
