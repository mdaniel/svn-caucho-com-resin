...
public class InElementItem extends Item {
   ...
   * Returns the first set, the set of element names possible.
   */
  public void requiredFirstSet(HashSet<NameCfg> set)
  {
   ...
   */
  public Item startElement(NameCfg name)
   ...
   */
  public void attributeSet(HashSet<NameCfg> set)
  {
   ...
   * @return the program for handling the element
   */
  public boolean allowAttribute(NameCfg name, String value)
    throws RelaxException
  {
   ...
   */
  public boolean allowsElement(NameCfg name)
  {
