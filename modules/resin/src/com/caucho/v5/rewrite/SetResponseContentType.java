...
import com.caucho.v5.http.rewrite.SetResponseContentTypeFilterChain;
 ...
 */
@Configurable
public class SetResponseContentType extends RewriteFilterBase
{
  private static final L10N L = new L10N(SetResponseContentType.class);
  ...
  protected FilterChain createFilterChain(String uri,
                                          ...
                                          FilterChain next)
  {
    return new SetResponseContentTypeFilterChain(next, _value);
  }
}
