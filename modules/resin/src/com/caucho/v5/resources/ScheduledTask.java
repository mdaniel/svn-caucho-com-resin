  ...
  implements AlarmListener, EnvironmentListener
{
  ...
  public void handleAlarm(Alarm alarm)
  {
    ...
    try {
      ...
      if (nextTime != _nextTime && _nextTime <= now) {
  ...
  public static class MethodTask implements Runnable {
    ...
    {
      _method = method;
      _elContext = new CandiELContext(CandiManager.create());
    }
  ...
  */
  ...
  public class ServletTask implements Runnable {
    ...
    public void run()
    {
      RequestServletStub req = new RequestServletStub();
      ResponseServletStub res = new ResponseServletStub();
