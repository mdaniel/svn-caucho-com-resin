 ...
 */
@Module
public class InjectionTargetCustomBean<X> 
  implements InjectionTarget<X>,
             DisplayableInjectionTarget
{
  private ManagedBeanImpl<X> _customBean;
  ...
  public InjectionTargetCustomBean(ManagedBeanImpl<X> bean,
                            Constructor<X> ctor,
                            Arg<X> []newProgram,
  ...
  public void inject(X instance, CreationalContext<X> env)
  {
    ...
    if (_injectProgram.length > 0) {
      InjectContext injectCxt = null;
      
      for (ConfigProgram program : _injectProgram) {
        program.inject(instance, injectCxt);
      }
    }
  }
  ...
  {
    return _customBean.toDisplayString();
  }
}
