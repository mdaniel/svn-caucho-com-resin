...
public class AspectGeneratorUtil {
  ...
  */
    ...
    throws IOException
  {
    ...
    Type []javaParams = javaMethod.getGenericParameterTypes();
    for (int i = 0; i < params.size(); i++) {
      AnnotatedParameter<?> param = params.get(i);

      Type annotatedType = param.getBaseType();
      Type type = javaParams[i];

      //XXX: check type compatible with annotatedType
