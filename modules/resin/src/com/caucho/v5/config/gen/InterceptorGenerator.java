...
import com.caucho.v5.config.candi.InterceptorBean;
import com.caucho.v5.config.candi.InterceptorRuntimeBean;
import com.caucho.v5.config.candi.InterceptorSelfBean;
  ...
  extends AbstractAspectGenerator<X>
{
                              ...
                              boolean isExcludeClassInterceptors)
  {
    ...
    if (methodInterceptorMap != null) {
      ...
      Collections.sort(_interceptorBinding, ComparatorInterceptor.CMP);
    }
   ...
   */
    ...
    if (isPassivating()) {
      ...
      out.println();
      out.print("com.caucho.v5.config.gen.CandiUtil.validatePassivating(");
    ...
    out.println("  __caucho_exception = com.caucho.v5.config.ConfigException.create(e);");
    out.println("}");
    out.popDepth();
    out.println("}");
...
//    if (getMethod() != null)
    ...
    throws IOException
  {
    ...
    if (map.get("__caucho_manager") == null) {
      ...
      out.printClass(CandiManager.class);
      ...
      out.printClass(BeanManagerBase.class);
      out.println(" __caucho_bean_manager = __caucho_manager.getBeanManager(");
    ...
    throws IOException
  {
    ...
    out.println("  " + CandiUtil.class.getName() + ".createInterceptors(");
    out.println("    __caucho_bean_manager,");
    out.println("    __caucho_interceptor_static_beans,");
    out.println("    __caucho_interceptor_beans,");
    ...
    out.println("  " + CandiUtil.class.getName() + ".createMethods(");
    out.println("    __caucho_interceptor_beans,");
    out.println("    " + InterceptionType.class.getName()
                + "." + _interceptionType + ",");
    out.println("    " + chainName + "_objectIndexChain);");
    ...
    if (isPassivating()) {
      ...
      out.println();
      out.print(CandiUtil.class.getName() + ".validatePassivating(");
      out.print(beanClassName + ".class, ");
      out.println("__caucho_interceptor_beans);");
    }
  }
    ...
    throws IOException
  {
    ...
    if (getMethod() == null
      ...
      out.println("com.caucho.v5.config.gen.CandiUtil.NULL_OBJECT_ARRAY");
    }
    else {
    ...
    throws IOException
  {
    ...
    for (Method method : methodList) {
      ...
      out.print(" = com.caucho.v5.config.gen.CandiUtil.createDecoratorMethods(decoratorList, ");
    ...
    if (isPassivating()) {
      ...
      out.println();
      out.print("com.caucho.v5.config.gen.CandiUtil.validatePassivatingDecorators(");
      out.print(beanClassName + ".class, ");
    ...
    throws IOException
  {
    ...
    if (annMethod != null && annMethod.isAnnotationPresent(Inject.class)) {
      ...
      out.println();
      out.print("var._index = com.caucho.v5.config.gen.CandiUtil.nextDelegate(");
      out.print("delegates, ");
      /*
      if (apis.size() > 1) {
        out.print(apiName);
      ...
      */
      ...
      for (int j = 0; j < apis.size(); j++) {
        ...
        */
        ...
        out.print("com.caucho.v5.config.gen.CandiUtil.invoke(");
        out.print("_caucho_decorator_" + method.getName() + "_m[");
...
*/
  ...
  private static class ComparatorInterceptor implements Comparator<Annotation> {
    private static ComparatorInterceptor CMP = new ComparatorInterceptor();

    @Override
    public int compare(Annotation a, Annotation b)
    {
      int cmp = a.annotationType().getName().compareTo(b.annotationType().getName());
