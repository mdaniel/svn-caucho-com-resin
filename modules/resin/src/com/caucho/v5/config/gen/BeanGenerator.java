...
import com.caucho.v5.java.gen.DependencyComponent;
import com.caucho.v5.java.gen.GenClass;
import com.caucho.v5.make.ClassDependency;
import com.caucho.v5.make.VersionDependency;
...
abstract public class BeanGenerator<X> extends GenClass
{
    ...
    throws IOException
  {
    ...
    out.println();
    out.println("public void __caucho_destroy(com.caucho.v5.config.inject.CreationalContextImpl env)");
    out.println("{");
    out.pushDepth();
    ...
    throws IOException
  {
    ...
    out.println("public Object []__caucho_inject(Object []delegates"
                + ", Object []interceptors"
                + ", com.caucho.v5.config.inject.CreationalContextImpl<?> parentEnv)");
    out.println("{");
    out.pushDepth();
  ...
  public void generateCauchoDefaultInit(JavaWriter out,
                                        HashMap<String,Object> map)
    throws IOException
  {
    for (AspectGenerator<X> method : getMethods()) {
      method.generateCauchoProxyFactoryInit(out, map);
    }
  }
