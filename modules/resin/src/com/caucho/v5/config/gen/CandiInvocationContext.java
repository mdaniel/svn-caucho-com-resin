...
import com.caucho.v5.config.candi.AbstractInvocationContext;
import com.caucho.v5.loader.EnvironmentLocal;
import com.caucho.v5.util.L10N;

public class CandiInvocationContext extends AbstractInvocationContext
{
    ...
    throws Exception
  {
    ...
    try {
      ...
      if (_chainObjects != null && _index < _chainIndex.length) {
        ...
        result = _implMethod.invoke(_target, getParameters());
      }
  ...
  {
    return _apiMethod.getDeclaringClass();
  }

  @Override
  protected String getName()
  {
    return _apiMethod.getName();
  }
