...
import com.caucho.v5.config.reflect.VarType;
...
abstract public class AbstractAspectGenerator<X> implements AspectGenerator<X> {
    ...
    throws IOException
  {
    ...
    while ((exn = selectException(exceptionSet)) != null) {
      boolean isSystemException = isSystemException(exn);
  ...
  protected boolean isSystemException(Class<?> exn)
  {
    return (RuntimeException.class.isAssignableFrom(exn)
  ...
  @Override
  public void generateCauchoProxyFactoryInit(JavaWriter out,
                                             HashMap<String,Object> map)
    throws IOException
  {
    _next.generateCauchoProxyFactoryInit(out, map);
  }
