 ...
 */
@Module
public class AspectBeanFactoryCandi<X> implements AspectBeanFactory<X> {
  private CandiManager _manager;
  
  private AnnotatedType<X> _beanType;
  private AspectFactory<X> _factory;
  
  public AspectBeanFactoryCandi(CandiManager manager,
  ...
  {
    return getBeanType().getJavaClass().getSimpleName() + "__CauchoCdi";
  }
