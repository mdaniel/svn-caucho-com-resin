 ...
 * </pre></code>
 */
abstract public class SingletonBeanBase<T> extends BeanWrapper<T>
  implements Closeable, AnnotatedBean, PassivationCapable
{
  ...
  SingletonBeanBase(ManagedBeanImpl<T> managedBean,
                        Set<Type> types,
                        Annotated annotated,
                        ...
                        String name)
  {
    super(managedBean.getInjectManager(), managedBean);
