  ...
  implements WithBeanManager
{
  ...
  public InterceptorBean(CandiManager cdiManager,
                         Class<X> type,
                         BeanManagerBase beanManager)
  {
    ...
    AnnotatedType<X> annType = cdiManager.createAnnotatedType(_type);
    AnnotatedTypeImpl<X> enhAnnType
      = AnnotatedTypeImpl.create(annType, beanManager);
    
    enhAnnType.addAnnotation(new InterceptorLiteral());
    _bean = cdiManager.createManagedBean(enhAnnType);
  ...
  public InterceptorBean(Class<X> type)
  {
    this(CandiManager.create(), 
         type, 
         CandiManager.create().getBeanManager(type));
  }
  ...
  boolean isAroundConstruct()
  {
    return super.getMethod(InterceptionType.AROUND_CONSTRUCT) != null;
  }
