 ...
 */
@Module
public class NewBean<X> extends IntrospectedBeanBase<X>
{
  private InjectionTargetBuilder<X> _target;
  private LinkedHashSet<Annotation> _qualifiers;
  private Set<Type> _types;

  NewBean(CandiManager inject,
          Class<?> newType,
          AnnotatedType<X> beanType)
  {
    super(inject, beanType.getBaseType(), beanType, null);
    ...
    _types = inject.createSourceBaseType(newType).getTypeClosure(inject.getTypeFactory());
