 ...
 */
@Module
abstract public class BeanAdapter<X,T> extends BeanBase<T>
{
  private final Bean<X> _bean;

  public BeanAdapter(CandiManager manager, Bean<X> bean)
  {
    super(manager);
  ...
  {
    if (_bean instanceof WithBeanManager) {
      return ((WithBeanManager) _bean).getBeanManager();
    }
    else {
