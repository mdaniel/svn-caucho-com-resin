...
import com.caucho.v5.bytecode.JavaField;
...
public class ScopeAdapter {
  ...
  private ObjectFactory<?> _proxyFactory;
  
  protected ScopeAdapter(Class<?> beanClass, Class<?> cl, Class<?> []types)
  {
    _types = types;
  ...
  {
    BaseType baseType = CandiManager.getCurrent().createTargetBaseType(type);
    ...
    if (rawType.isArray())
      throw new DeploymentException(L.l("'{0}' is an invalid @NormalScope bean because it's a Java array.",
                                        baseType));
    
  }
  
  @SuppressWarnings("unchecked")
  public <X> X wrap(ReferenceFactory<X> factory)
  {
    try {
  ...
  private void generateProxy(Class<?> cl, Class<?> []types)
  {
    try {
      ...
      String thisClassName = typeClassName + "__CauchoScopeProxy";
      ...
      if (_proxyClass == null) {
        ...
        JavaField factoryField =  jClass.createField("_factory", ReferenceFactory.class);
      ...
      ObjectFactoryBuilder builder = ObjectFactoryBuilder.getInstance();
      _proxyFactory = builder.build(_proxyClass);
                                 ...
                                 boolean isInterface)
  {
    ...
    code.pushObjectVar(0);
    code.getField(jClass.getThisClass(), "_factory", ReferenceFactory.class);
    
    code.invoke(ReferenceFactory.class,
                "create",
                Object.class);
  ...
  private void createSerialize(JavaClass jClass)
  {
    ...
    code.newInstance("com/caucho/v5/config/bytecode/ScopeProxyHandle");
    code.dup();
    ...
    code.invokespecial(ScopeProxyHandle.class,
                       "<init>",
                       void.class,
                       ReferenceFactory.class);
