 ...
 */
public class ProgramAssign extends ProgramBase
{
  private final String _id;
  private final String _value;
  
  ProgramAssign(ConfigContext config,
                String id, 
                String value)
  {
    super(config);
  ...
  {
    if (ConfigContext.getProperty(_id) == null) {
      ConfigContext.setProperty(_id, _value);
    }
  }
