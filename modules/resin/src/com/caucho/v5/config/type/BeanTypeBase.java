 ...
 * value in webbeans.
 */
public class BeanTypeBase<X> extends InlineBeanType<X>
{
  private static final L10N L = new L10N(BeanTypeBase.class);
   ...
   */
  public BeanTypeBase(TypeFactoryConfig typeFactory, Class<X> type)
  {
    super(typeFactory, type);
  ...
  {
    ConfigInterface cfg = new ConfigInterface(name, _type, parent);
  ...
  protected Object initJndi(String value)
  {
    // Jndi.lookup(value);
    return null;
  }
