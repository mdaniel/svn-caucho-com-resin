...
package com.caucho.v5.config.async;
...
abstract public class AsyncItem<X> implements Runnable, Future<X> {
  ...
  public final void run()
  {
    try {
      ...
      _executionException = new ExecutionException(e);//new EJBException(e));
    } catch (Exception e) {
      log.log(Level.FINER, e.toString(), e);
      ...
      _executionException = new ExecutionException(e);//new EJBExceptionWrapper(e));
    } finally {
      _isDone = true;
      _localItem.set(null);
