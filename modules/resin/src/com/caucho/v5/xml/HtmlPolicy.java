...
class HtmlPolicy extends Policy {
  ...
  static NameCfg htmlName = new NameCfg(null, "html", null);
  static NameCfg headName = new NameCfg(null, "head", null);
  static NameCfg bodyName = new NameCfg(null, "body", null);
   ...
   * @return the normalized name.
   */
  NameCfg getName(CharBuffer tag)
  {
    if (! toLower)
