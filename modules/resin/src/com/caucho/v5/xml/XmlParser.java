...
import com.caucho.v5.xml.readers.Utf8Reader;
import com.caucho.v5.xml.readers.XmlReader;
...
public class XmlParser extends AbstractParser {
  ...
  static final NameCfg DOC_NAME = new NameCfg(null, "#document", null);
  static final NameCfg TEXT_NAME = new NameCfg(null, "#text", null);
  static final NameCfg JSP_NAME = new NameCfg(null, "#jsp", null);
  static final NameCfg WHITESPACE_NAME = new NameCfg(null, "#whitespace", null);
  static final NameCfg JSP_ATTRIBUTE_NAME = new NameCfg("xtp", "jsp-attribute", null);
  ...
  NameCfg []_elementNames = new NameCfg[64];
    ...
    throws IOException, SAXException
  {
    ...
    NameCfg qname = _policy.getName(_eltName);
    ...
    while (ch != -1) {
      ...
      if (! _text.startsWith("xmlns")) {
        ...
        if (_isNamespaceAware && _contentHandler instanceof DOMBuilder)
          ...
          name = new NameCfg(_text.toString(), null);
    ...
    throws IOException, SAXException
  {
    ...
    for (int i = 0; i < _attributes.getLength(); i++) {
      NameCfg name = _attributes.getName(i);
   ...
   */
  private void addElement(NameCfg child, boolean isEmpty,
      ...
      case Policy.PUSH:
        ...
        if (isEmpty) {
          ...
          if (_elementTop == _elementNames.length) {
            ...
            NameCfg []names = new NameCfg[2 * len];
   ...
   */
  private void addChild(NameCfg child)
    throws IOException, SAXException
  {
