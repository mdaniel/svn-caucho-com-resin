...
public class OutPdf {
  private static final Logger log
    = Logger.getLogger(OutPdf.class.getName());
  private static final L10N L = new L10N(OutPdf.class);
  ...
  private String _creator = "Baratine PDF";
  private String _author;
  private String _title;

  private ArrayList<ObjectPdf> _pendingObjects
    = new ArrayList<>();
  ...
  public void writeOutline(OutlinePdf outline)
    throws IOException
  {
    List<DestinationPdf> roots = outline.getRootDestinations();
  ...
  private void writeOutlineItem(List<DestinationPdf> destinations, int index)
    throws IOException
  {
    DestinationPdf dest = destinations.get(index);
    
    List<DestinationPdf> children = dest.getChildren();
    ...
    println("  << /Title (" + StreamPdf.pdfEscapeText(dest.getTitle()) + ")");
  ...
  public void writePageGroup(int id, int parentId, ArrayList<PagePdf> pages)
    throws IOException
  {
    beginObject(id);
    println("  << /Type /Pages");
  ...
  public void writeStream(int id, StreamPdf stream)
    throws IOException
  {
    stream.flush();
  ...
  public void addPendingObject(ObjectPdf obj)
    throws IOException
  {
    ...
    throws IOException
  {
    ...
    for (int i = _pendingObjects.size() - 1; i >= 0; i--) {
      ObjectPdf obj = _pendingObjects.get(i);
