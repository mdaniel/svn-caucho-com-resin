...
public class StreamPdf {
  private static final Logger log
    = Logger.getLogger(StreamPdf.class.getName());
  private static final L10N L = new L10N(StreamPdf.class);
  ...
  private ProcSetPdf _procSet;
  private FontPdf _font;
  ...
  public boolean fit_image(ImagePdf img)
  {
    _procSet.add("/ImageB");
    _procSet.add("/ImageC");
    _procSet.add("/ImageI");
  ...
  public boolean fit_file_image(ImageFilePdf img)
  {
    _procSet.add("/ImageB");
    _procSet.add("/ImageC");
    _procSet.add("/ImageI");
