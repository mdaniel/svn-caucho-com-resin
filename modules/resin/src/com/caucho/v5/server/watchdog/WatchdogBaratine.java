 ...
 */
public class WatchdogBaratine extends WatchdogMain
{
  protected WatchdogBaratine(String []argv)
    throws Exception
  {
    super(argv);
  }
  ...
  {
    ArgsWatchdog args = new ArgsWatchdog(getArgv(), new ProgramInfoBaratine());
