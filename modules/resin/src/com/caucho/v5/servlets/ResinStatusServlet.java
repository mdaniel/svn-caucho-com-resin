  ...
  */
    ...
    throws IOException, ServletException
  {
    try {
      ...
      for (int i = 0; i < clusterList.length; i++) {
        ObjectName name = new ObjectName(clusterList[i]);
        
        ClusterMXBean cluster
          = JMX.newMXBeanProxy(_mbeanServer, name, ClusterMXBean.class);
    ...
    throws Exception
  {
    ...
    while (iter.hasNext()) {
      ...
      ConnectionPoolMXBean pool
        = JMX.newMXBeanProxy(_mbeanServer, name, ConnectionPoolMXBean.class);
  ...
  */
    ...
    throws Exception
  {
    ...
    while (iter.hasNext()) {
      ...
      HostMXBean host = JMX.newMXBeanProxy(_mbeanServer, name, HostMXBean.class);
    ...
    for (int i = 0; i < hosts.size(); i++) {
      ...
      while (iter.hasNext()) {
        ...
        try {
          WebAppMXBean app = JMX.newMXBeanProxy(_mbeanServer, name, WebAppMXBean.class);
    ...
    throws IOException, ServletException
  {
    ...
    */
      out.println("<br><em>" + Version.getFullVersion() + "</em>");
  }
