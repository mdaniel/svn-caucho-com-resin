...
public class InterpolateExpr extends Expr {
  ...
  public String toString()
  {
    ...
    if (_left instanceof StringLiteral) {
      StringLiteral leftString = (StringLiteral) _left;
      
      sb.append(leftString.getValue());
    }
    else if (_left instanceof InterpolateExpr) {
      sb.append(_left);
    }
    else {
      sb.append("${" + _left + "}");
    ...
    if (_right instanceof StringLiteral) {
      StringLiteral rightString = (StringLiteral) _right;
    
      sb.append(rightString.getValue());
    }
    else if (_right instanceof InterpolateExpr) {
      sb.append(_right);
    }
    else {
      sb.append("${" + _right + "}");
  ...
  public void printCreate(WriteStream os)
    throws IOException
  {
    os.print("new com.caucho.v5.el.InterpolateExpr(");
