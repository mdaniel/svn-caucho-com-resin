 ...
 */
public class LinkProxy implements ObjectFactoryNaming, java.io.Serializable {
    ...
    throws NamingException
  {
    ...
    if (_foreignName != null) {
      ...
      if (_factoryClass != null)
        ...
        foreignName = JndiUtil.getFullName(_foreignName);
    ...
    throws Exception
  {
    ...
    if (_foreignName != null
        && JndiUtil.getFullName(_jndiName).equals(JndiUtil.getFullName(_foreignName)))
      return;

    // server/155a - not a short link since it needs to be able to bind
    // the jndi root
    if (_jndiLocalName != null)
      JndiUtil.rebindDeep(_jndiLocalName, this);
    else
      JndiUtil.rebindDeepShort(_jndiName, this);
  }
