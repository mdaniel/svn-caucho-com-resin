...
public class LogMessage
{
  ...
  public static LogMessage from(CompositeData data)
  {
    LogMessage msg = new LogMessage();
    
    msg.setType((String) data.get("type"));
    msg.setName((String) data.get("name"));
    msg.setServer((String) data.get("server"));
    msg.setThread((String) data.get("thread"));
    msg.setTimestamp((Long) data.get("timestamp"));
    msg.setLevel((String) data.get("level"));
