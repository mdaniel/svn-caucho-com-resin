...
public interface LogServiceMXBean extends ManagedObjectMXBean
{
  ...
  public LogMessage []findMessages(@Name("level") String level, 
                                   @Name("minTime") long minTime, 
                                   @Name("maxTime") long maxTime);
  
  public LogMessage []findMessagesByName(@Name("name") String name,
                                         @Name("level") String level,
                                         @Name("minTime") long minTime, 
                                         @Name("maxTime") long maxTime);
  
  public long []findMessageTimesByType(@Name("type") String type,
                                       @Name("level") String level,
                                       @Name("minTime") long minTime, 
                                       @Name("maxTime") long maxTime);
  
  public LogMessage []findMessagesByType(@Name("type") String type,
                                         @Name("level") String level,
                                         @Name("minTime") long minTime, 
                                         @Name("maxTime") long maxTime);
}
