 ...
 */
public class ClientEjbRef implements ObjectFactoryNaming {
   ...
   * For remote beans, a &lt;jndi-link> {@link com.caucho.v5.naming.LinkProxy} is
    ...
    throws Exception
  {
    ...
    _ejbRefName = JndiUtil.getFullName(_ejbRefName);
    ...
    throws NamingException
  {
    ...
    Object value = context.lookup(JndiUtil.getFullName(_ejbLink));
