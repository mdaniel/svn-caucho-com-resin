 ...
 */
public class FilterChainContextResin extends FilterChainContext
{
  private static final Logger log
    = Logger.getLogger(FilterChainContextResin.class.getName());
   ...
   */
  public FilterChainContextResin(FilterChain next)
  {
    super(next);
