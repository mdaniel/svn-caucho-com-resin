 ...
 */
class ResponseForward extends ResponseCauchoWrapper
{
  ResponseForward(RequestForward request)
  {
    super(request);
  }

  ResponseForward(RequestForward request, HttpServletResponse response)
  {
