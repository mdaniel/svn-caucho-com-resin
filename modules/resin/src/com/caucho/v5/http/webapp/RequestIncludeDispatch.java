 ...
 */
class RequestIncludeDispatch extends RequestDispatchBase {
  protected static final Logger log
    = Logger.getLogger(RequestIncludeDispatch.class.getName());

  private static final FreeList<RequestIncludeDispatch> _freeList
    = new FreeList<RequestIncludeDispatch>(32);
  
  private Hashtable<String,String> _headers;
  
  protected RequestIncludeDispatch()
  {
  }
   ...
   */
  public static RequestIncludeDispatch createDispatch()
  {
    RequestIncludeDispatch req = _freeList.allocate();
    if (req == null)
      req = new RequestIncludeDispatch();
   ...
   * Frees the request.
   */
  public static void free(RequestIncludeDispatch req)
  {
    req.free();
