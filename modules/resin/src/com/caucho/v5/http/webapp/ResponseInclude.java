 ...
 */
public class ResponseInclude extends ResponseCauchoWrapper
{
  private static final L10N L = new L10N(ResponseInclude.class);
  
  private final OutResponseInclude _originalStream
    = new OutResponseInclude(this);
  ...
  ResponseInclude(RequestInclude request)
  {
    super(request);
  }
  
  ResponseInclude(RequestInclude request, HttpServletResponse response)
  {
  ...
  public RequestInclude getRequest()
  {
    return _request;
  }
  ...
  public boolean isForwardEnclosed()
  {
    if (_isForwardEnclosed)
      return true;
    else if (getResponse() instanceof ResponseCaucho)
      return ((ResponseCaucho) getResponse()).isForwardEnclosed();
    else
      return false;
  }
}
