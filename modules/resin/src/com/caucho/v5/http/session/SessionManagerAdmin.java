 ...
 */
public class SessionManagerAdmin extends ManagedObjectBase
  implements SessionManagerMXBean
{
  ...
  {
    return _manager.isEnableSessionCookies();
  }
  ...
  {
    return _manager.isEnableSessionUrls();
  }
  ...
  public int stickySessionServer(String sessionId, int count)
  {
    ...
    ServerBartender server = servlet.getSelfServer();
    
    // return hash % server.getRack().getServerLength();
