 ...
 */
public class FilterChainSingleThreadServlet implements FilterChain {
  // servlet config
  private ServletBuilder _config;
  // servlet
   ...
   */
  public FilterChainSingleThreadServlet(ServletBuilder config)
  {
    if (config == null)
