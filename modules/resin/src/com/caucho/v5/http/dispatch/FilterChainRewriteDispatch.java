 ...
 */
public class FilterChainRewriteDispatch implements FilterChain {
  private static final Logger log 
    = Logger.getLogger(FilterChainRewriteDispatch.class.getName());
  // servlet
  private String _url;
   ...
   */
  public FilterChainRewriteDispatch(String url)
  {
    _url = url;
  }
