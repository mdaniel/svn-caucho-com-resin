 ...
 */
public class FilterChainMoved implements FilterChain {
  private int _code;
  private String _url;
   ...
   */
  public FilterChainMoved(int code, String url)
  {
    _code = code;
    _url = url;
  }
   ...
   * @param url the URL to redirect to.
   */
  public FilterChainMoved(int code, String url, String queryString)
  {
    _code = code;
    _url = url;
