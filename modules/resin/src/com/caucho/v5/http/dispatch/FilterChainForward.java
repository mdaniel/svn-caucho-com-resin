 ...
 */
public class FilterChainForward implements FilterChain {
  private static final Logger log
    = Logger.getLogger(FilterChainForward.class.getName());
   ...
   */
  public FilterChainForward(String url)
  {
    _url = url;
  }
   ...
   */
  public FilterChainForward(RequestDispatcher disp)
  {
    _disp = disp;
  }
