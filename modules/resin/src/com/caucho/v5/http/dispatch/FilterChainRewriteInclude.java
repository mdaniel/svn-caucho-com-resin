 ...
 */
public class FilterChainRewriteInclude implements FilterChain {
  private static final Logger log 
    = Logger.getLogger(FilterChainRewriteInclude.class.getName());
   ...
   */
  public FilterChainRewriteInclude(FilterChain next, String url)
  {
    _url = url;
  }
