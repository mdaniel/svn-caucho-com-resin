 ...
 */
class ClientGroupLoadBalanceStatic 
  extends ClientGroupLoadBalanceBase
{
  private final ClientSocketFactory []_clientList;
  
  ClientGroupLoadBalanceStatic(ArrayList<ClientSocketFactory> clientList)
  {
    _clientList = new ClientSocketFactory[clientList.size()];
    
    clientList.toArray(_clientList);
  }
