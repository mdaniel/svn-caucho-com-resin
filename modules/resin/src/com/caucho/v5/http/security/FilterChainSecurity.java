...
public class FilterChainSecurity implements FilterChain {
  private FilterChain _next;

  private ServletContext _webApp;

  private ConstraintBase []_constraints;
  private HashMap<String,ConstraintBase[]> _methodMap;

  FilterChainSecurity(FilterChain next)
  {
    _next = next;
  }
  ...
  public void setConstraints(ArrayList<ConstraintBase> constraints)
  {
    _constraints = new ConstraintBase[constraints.size()];

    constraints.toArray(_constraints);
  }

  public void setMethodMap(HashMap<String,ConstraintBase[]> methodMap)
  {
    ...
    throws ServletException, IOException
  {
    ...
    RequestCaucho req = (RequestCaucho) request;
    ResponseCaucho res = (ResponseCaucho) response;

    ConstraintBase []constraints = null;
    if (_methodMap != null)
