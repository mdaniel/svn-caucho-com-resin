 ...
 */
public class PasswordUser2 implements Serializable
{
  ...
  public PasswordUser2(Principal principal,
                      char []password,
                      boolean isDisabled,
                      boolean isAnonymous,
                      String []roles)
  ...
  public PasswordUser2(String user,
                      char []password,
                      String []roles)
  {
  ...
  public PasswordUser2(String user, String password)
  {
   ...
   * Creates a copy
   */
  public PasswordUser2 copy()
  {
    return new PasswordUser2(_principal, _password,
