...
@Singleton
public class DigestLogin extends LoginBase
{
    ...
    throws ServletException, IOException
  {
    ...
    Base64Util.encode(cb, RandomUtil.getRandomLong());
  ...
  {
    int ch;
    while (Character.isWhitespace((ch = cursor.current())) || ch == ',') {
      cursor.next();
    }
    ...
    while (Character.isJavaIdentifierPart(ch = cursor.read())) {
      cb.append((char) ch);
    }
