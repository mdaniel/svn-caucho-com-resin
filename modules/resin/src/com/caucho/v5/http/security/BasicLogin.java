 ...
 */
@CauchoBean
public class BasicLogin extends LoginBase {
  ...
  protected Principal getUserPrincipalImpl(HttpServletRequest request)
  {
    ...
    if (authorization != null) {
      ...
      String decoded = Base64Util.decode(authorization.substring(i + 1));
                                     ...
                                     Principal savedUser)
  {
    ...
    String decoded = Base64Util.decode(value.substring(i + 1));
