...
public class OutResponseWrapper extends OutResponseBase {
  ...
  static final L10N L = new L10N(OutResponseWrapper.class);
  ...
  {
    if (_next instanceof ResponseServlet)
      return ((ResponseServlet) _next).isCauchoResponseStream();
    else
      return false;
  }
