...
import com.caucho.v5.vfs.AbstractPrintWriter;

import java.io.IOException;
import java.util.logging.Level;
import java.util.logging.Logger;

public class WriterHttp extends AbstractPrintWriter
{
  private static final Logger log
    = Logger.getLogger(WriterHttp.class.getName());
  static final L10N L = new L10N(WriterHttp.class);
  ...
  WriterHttp(OutResponseBase2 out)
  {
    _out = out;
  }

  public void init(OutResponseBase2 out)
  {
    _out = out;
    _hasError = false;
  }
