...
abstract public class OutResponseToChar extends OutResponseBase {
  ...
  static final L10N L = new L10N(OutResponseToChar.class);
    ...
    throws IOException
  {
    ...
    while (length > 0) {
      ...
      sublen = Math.min(sublen, SIZE - charLength);
    ...
    throws IOException
  {
    ...
    while (length > 0) {
      ...
      v.getChars(offset, charLength, _charBuffer, sublen);
      //System.arraycopy(buffer, offset, _charBuffer, charLength, sublen);
