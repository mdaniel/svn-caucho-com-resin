 ...
 */
public class AccessLogServlet extends AccessLogBase implements AlarmListener
{
  protected static final L10N L = new L10N(AccessLogServlet.class);
  protected static final Logger log
    = Logger.getLogger(AccessLogServlet.class.getName());
  ...
  private ArrayList<Segment> parseFormat(String format)
  {
    ...
    cb.append(CauchoUtil.getNewlineString());
    segments.add(new Segment(this, Segment.TEXT, cb.toString()));
  ...
  {
    // server/1kk7
    RequestCaucho cRequest = (RequestCaucho) req;
  ...
  private int log(RequestServlet request,
   ...
   // throws IOException
  {
    final RequestHttpBase absRequest = request.getAbstractHttpRequest();
    CharBuffer cb = _cb;
  ...
  static class Segment {
     ...
     */
    Segment(AccessLogServlet log, int code, String string)
    {
      _log = log;
      _code = code;
