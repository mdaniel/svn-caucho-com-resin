 ...
 */
public interface PodBuilderServiceSync extends PodBuilderService
{
  Void buildPod(PodBuilder podBuilder);

  PodBartender findPod(String name);

  List<DeployHandle<?>> getActiveHandles();
}
