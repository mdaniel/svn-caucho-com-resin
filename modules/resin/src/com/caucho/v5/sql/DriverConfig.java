...
import com.caucho.v5.sql.spy.SpyConnectionPoolDataSource;
import com.caucho.v5.tools.profiler.ConnectionPoolDataSourceWrapper;
import com.caucho.v5.tools.profiler.DriverWrapper;
import com.caucho.v5.tools.profiler.ProfilerPoint;
...
public class DriverConfig
{
    ...
    throws ConfigException
  {
    if (dataSource instanceof String)
      dataSource = JndiUtil.lookup((String) dataSource);
    ...
    throws SQLException
  {
    ...
    ConfigType<?> configType = TypeFactoryConfig.getType(driverObject);
