 ...
 */
public interface DeployControllerExpandApi<I extends DeployInstance>
  extends DeployController<I>
{
  // DeployControllerApi<I> findController(String name);
  
  void addParentExpandCleanupFileSet(FileSetType fileSet);
