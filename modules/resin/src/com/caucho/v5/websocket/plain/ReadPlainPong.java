 ...
 * Callback for reads.
 */
class ReadPlainPong extends ReadPlain {
  private final MessageHandler.Whole<PongMessage> _handler;
  
  ReadPlainPong(MessageHandler.Whole<PongMessage> handler)
  {
    _handler = handler;
  }
