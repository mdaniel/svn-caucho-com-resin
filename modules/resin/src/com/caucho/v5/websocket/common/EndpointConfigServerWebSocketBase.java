   ...
   implements ServerEndpointConfig
{
  ...
  protected EndpointConfigServerWebSocketBase(Class<?> endpointConfig, String path)
  {
    ServerEndpointConfig.Builder builder;
    builder = ServerEndpointConfig.Builder.create(endpointConfig, path);
    
    _delegate = builder.build();
  }
