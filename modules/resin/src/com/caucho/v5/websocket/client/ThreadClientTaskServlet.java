 ...
 * WebSocketClient
 */
class ThreadClientTaskServlet implements Runnable {
  private final Logger log = Logger.getLogger(ThreadClientTaskServlet.class.getName());
  
  private WebSocketClientServlet _client;
  
  ThreadClientTaskServlet(WebSocketClientServlet client)
  {
    _client = client;
  }
