...
public interface QueueService
{
  ...
  void message(long sid,
               long mid, 
               byte[] buffer, int offset, int length,
               TempBuffer tBuf,
               SenderSettleHandler settleHandler);

  void accepted(ReceiverBrokerNautilus receiver,
                MessageNautilus msg);

  //void accepted(ReceiverBrokerNautilus receiver, long mid);
  
  void subscribe(ReceiverBrokerNautilus receiver);
  
  void unregister(long id, ReceiverBrokerNautilus receiver);
   ...
   * Receive from remote.
   */
  void onReceive(long messageId, StreamSource ss);
