...
import com.caucho.v5.management.server.AmpSystemMXBean;


/**
 * Statistics for AMP service registered in the Resin network.
 */
public class AmpSystemAdmin 
  extends ManagedObjectBase 
  implements AmpSystemMXBean
{
  ...
  {
    return _ampSystem.getExternalMessageReadCount();
  }

  @Override
  public long getExternalMessageWriteCount()
  {
    return _ampSystem.getExternalMessageWriteCount();
  }
}
