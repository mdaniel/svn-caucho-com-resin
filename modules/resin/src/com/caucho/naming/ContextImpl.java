...
public class ContextImpl implements Context {
  ...
  {
    try {
      if (value instanceof ObjectFactoryNaming)
        return ((ObjectFactoryNaming) value).createObject(_env);
    ...
    throws NamingException
  {
    ...
    if (obj instanceof ObjectFactoryNaming)
      return ((ObjectFactoryNaming) obj).createObject(_env);
    else
      return obj;
  }
