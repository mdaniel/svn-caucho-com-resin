...
/**
 * Sends formatted messages to HMPP target
 */
public class HmppHandler extends Handler {
  private static final Logger log
    = Logger.getLogger(HmppHandler.class.getName());
  private static final L10N L = new L10N(HmppHandler.class);

  @In private HmppConnectionFactory _factory;
