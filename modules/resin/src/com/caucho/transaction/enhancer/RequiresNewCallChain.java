 ...
 */
public class RequiresNewCallChain extends FilterCallChain {
  private static final L10N L = new L10N(RequiresNewCallChain.class);
  
  public RequiresNewCallChain(CallChain next)
  {
    super(next);
  }
