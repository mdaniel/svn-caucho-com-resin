 ...
 */
public class SuspendCallChain extends FilterCallChain {
  private static final L10N L = new L10N(SuspendCallChain.class);
  
  public SuspendCallChain(CallChain next)
  {
    super(next);
  }
    ...
    throws IOException
  {
    ...
    out.println("_caucho_xa = _caucho_xa_c.beginSuspend();");
    ...
    out.popDepth();
    out.println("} finally {");
    out.println("  _caucho_xa_c.rollback(_caucho_xa);");
    out.println("}");
  }
}
