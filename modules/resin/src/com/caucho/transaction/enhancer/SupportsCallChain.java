...
/**
 * Enhancing the method for a 'Supports' transaction boundary.
 */
public class SupportsCallChain extends FilterCallChain {
  private static final L10N L = new L10N(SupportsCallChain.class);
  
  public SupportsCallChain(CallChain next)
  {
    super(next);
  }
