 ...
 */
@Configurable
public class Location extends DispatchRuleRegexpBase
{
  private ArrayList<DispatchRuleBase> _ruleList
    = new ArrayList<DispatchRuleBase>();

  private DispatchRuleBase []_rules = new DispatchRuleBase[0];
  ...
  {
    _ruleList.add(rule);
    _rules = new DispatchRuleBase[_ruleList.size()];
                               ...
                               FilterChain chain)
  {
    try {
      ...
      DispatchRuleBase rule = _rules[index];
