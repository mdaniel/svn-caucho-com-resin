...
class StubGenerator extends MarshalGenerator {
  ...
  {
    return makeClient(cl, "__BurlapStub");
  }
   ...
   */
  Class makeClient(Class cl, String genSuffix)
    throws ConfigException
  {
    _cl = cl;
  ...
  private void generateJava(Method []methods)
    throws IOException
  {
    if (javax.ejb.EJBObject.class.isAssignableFrom(_cl))
      printHeader("ObjectStub");
    else if (javax.ejb.EJBHome.class.isAssignableFrom(_cl))
      printHeader("HomeStub");
    else
      printHeader("ObjectStub");

    // println("public String getBurlapType()");
    ...
    throws IOException
  {
    ...
    println("import com.caucho.ejb.burlap.*;");
    println("import com.caucho.burlap.io.*;");
    ...
    throws IOException
  {
    ...
    println("BurlapWriter out = _burlap_openWriter();");
    println("try {");
    pushDepth();
    ...
    println("BurlapInput in = out.doCall();");
    ...
    println("_burlap_freeWriter(out);");
    println("out = null;");
    ...
    throws IOException
  {
    ...
    println("{");
    pushDepth();
    println("return \"BurlapStub[" + _cl.getName() + ",\" + _urlPath + \"]\";");
    popDepth();
    println("}");
