...
import com.caucho.ejb.gen.ManyToOneSetter;
 ...
 */
public class CmpManyToOneSetter extends EjbMethod {
  private static final L10N L = new L10N(CmpManyToOneSetter.class);
   ...
   */
  public CmpManyToOneSetter(EjbView view, JMethod apiMethod, JMethod implMethod)
  {
  ...
  {
    BaseMethod method = new ManyToOneSetter(getApiMethod(),
