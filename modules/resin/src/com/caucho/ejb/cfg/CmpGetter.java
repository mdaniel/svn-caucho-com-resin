...
public class CmpGetter extends EjbMethod {
  private static final L10N L = new L10N(CmpGetter.class);
  ...
  {
    AmberGetter method = new AmberGetter(getApiMethod(),
					 getView().getImplClass().getName());

    method.setReadOnly(((EjbEntityBean) getView().getBean()).isReadOnly());
