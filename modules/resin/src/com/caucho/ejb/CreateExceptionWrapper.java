 ...
 */
public class CreateExceptionWrapper extends javax.ejb.CreateException {
  /**
   * Create a basic CreateExceptionWrapper with a message.
   *
   * @param msg the exception message.
   */
  public CreateExceptionWrapper(String msg)
  {
    super(msg);
  }
   ...
   */
  public CreateExceptionWrapper(Throwable rootCause)
  {
