 ...
 */
public class EntityHomePoolChain extends FilterCallChain {
  private static L10N L = new L10N(EntityHomePoolChain.class);

  public EntityHomePoolChain(CallChain next)
  {
    super(next);
  }
  ...
  public void generateCall(JavaWriter out, String retVar,
    ...
    throws IOException
  {
    out.println("Bean ptr = _context._ejb_begin(trans, true, false);");
