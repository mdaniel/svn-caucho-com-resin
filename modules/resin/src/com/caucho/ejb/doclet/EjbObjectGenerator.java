...
/**
 * Generates the object interface.
 */
public class EjbObjectGenerator {
  private static final Logger log = Log.open(EjbObjectGenerator.class);
  private static final L10N L = new L10N(EjbObjectGenerator.class);
  ...
  {
    _interfaceName = _classDoc.getAttribute("@ejb.home", "local-class");
    ...
    throws IOException, ConfigException
  {
    ...
    if (_isLocal) {
      String localExtends = _classDoc.getAttribute("@ejb.interface",
						   "local-extends");
	...
	localExtends = "javax.ejb.EJBLocalObject";
      ...
      String remoteExtends = _classDoc.getAttribute("@ejb.interface",
						    "extends");
  ...
  /**
   * Generates the methods the object.
   */
  public void generateMethods(JavaWriter out)
    throws IOException, ConfigException
  {
	...
	continue;
      ...
      if (tagList != null) {
        out.println();
        out.print("public " + method.getReturnType() + " ");
