...
public class SimpleActorProxy implements ActorProxy {
   ...
   */
  public void presence(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presence(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceUnavailable(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceUnavailable(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceProbe(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceProbe(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceSubscribe(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceSubscribe(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceSubscribed(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceSubscribed(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceUnsubscribe(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceUnsubscribe(getTo(), getJid(), payload);
  }
   ...
   * @param payload the presence payload
   */
  public void presenceUnsubscribed(Serializable payload)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceUnsubscribed(getTo(), getJid(), payload);
  }
   ...
   */
  public void presenceError(Serializable payload,
                            ActorError error)
  {
    ActorStream linkStream = getLinkStream();
    ...
    linkStream.presenceError(getTo(), getJid(), payload, error);
  }
