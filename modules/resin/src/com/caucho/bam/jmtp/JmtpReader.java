...
public class JmtpReader {
  ...
  static {
    ...
    _typeMap.put("presence", HmtpPacketType.PRESENCE);
    _typeMap.put("unavailable", HmtpPacketType.PRESENCE_UNAVAILABLE);
    _typeMap.put("probe", HmtpPacketType.PRESENCE_PROBE);
    _typeMap.put("subscribe", HmtpPacketType.PRESENCE_SUBSCRIBE);
    _typeMap.put("subscribed", HmtpPacketType.PRESENCE_SUBSCRIBED);
    _typeMap.put("unsubscribe", HmtpPacketType.PRESENCE_UNSUBSCRIBE);
    _typeMap.put("unsubscribed", HmtpPacketType.PRESENCE_UNSUBSCRIBED);
    _typeMap.put("presence_error", HmtpPacketType.PRESENCE_ERROR);
  }
}
