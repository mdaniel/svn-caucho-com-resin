 ...
 */
public final class ReceiverQueueCredit {
   ...
   */
  public final int getPrefetchAvailable()
  {
  ...
  {
    long clientQueueAvailable = getPrefetchAvailable();
  ...
  public final boolean updateCredit()
  {
    long creditEnd = _endpointSequence + _prefetch;
    
    if (creditEnd == _creditEnd) {
      return false;
    }
