 ...
 * Receiver builder
 */
public class ReceiverBuilderImpl<M> extends ReceiverBuilderBase<M>
{
  private final ContainerProviderImpl _container;

  public ReceiverBuilderImpl(ContainerProviderImpl container)
  {
  ...
  {
    return getContainer().receiver(getAddress(), createConfig());
  }

  @Override
  public ReceiverController build(ReceiverListener<M> receiver)
  {
    return getContainer().receiver(getAddress(), createConfig(), receiver);
  }
  ...
  private ReceiverConfigImpl<M> createConfig()
  {
    return new ReceiverConfigImpl<M>(this);
  }
}
