 ...
 */
public class EndpointConfigNautilus extends EndpointConfigServerWebSocketBase
{
  // private ServerEndpointConfig _config;
  private BrokerNautilus _broker;
  
  public EndpointConfigNautilus(String path)
  {
    super(EndpointServerNautilus.class, path);
  }
