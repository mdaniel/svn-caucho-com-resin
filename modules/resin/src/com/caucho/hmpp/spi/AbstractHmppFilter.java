 ...
 */
public class AbstractHmppFilter implements HmppStream
{
  private final HmppStream _next;

  protected AbstractHmppFilter(HmppStream next)
  {
    _next = next;
  }

  protected HmppStream getNext()
  {
    return _next;
  }
