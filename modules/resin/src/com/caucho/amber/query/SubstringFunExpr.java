 ...
 */
class SubstringFunExpr extends FunExpr {
  private static final L10N L = new L10N(SubstringFunExpr.class);

  /**
   * Creates a new expression
   */
  protected SubstringFunExpr(ArrayList<AmberExpr> args)
  {
    super("substring", args, false);
  }

  static FunExpr create(ArrayList<AmberExpr> args)
  {
    return new SubstringFunExpr(args);
  }
