 ...
 */
public class AndExp extends AbstractExp implements QueryExp {
  private QueryExp _v1;
  private QueryExp _v2;

  /**
   * Creates a new equal query.
   */
  public AndExp(QueryExp v1, QueryExp v2)
  {
    _v1 = v1;
    _v2 = v2;
  }
  ...
  {
    return _v1.apply(name) && _v2.apply(name);
  }
