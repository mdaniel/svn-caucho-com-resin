 ...
 */
public class MinusExp extends AbstractValueExp {
  private ValueExp _v1;
  private ValueExp _v2;

  /**
   * Creates a new equal query.
   */
  public MinusExp(ValueExp v1, ValueExp v2)
  {
    _v1 = v1;
    _v2 = v2;
  }
	   ...
	   BadAttributeValueExpException, InvalidApplicationException
  {
    ...
    if (v1 instanceof DoubleValueExp || v2 instanceof DoubleValueExp)
      return new DoubleValueExp(toDouble(v1) - toDouble(v2));
    else
      return new LongValueExp(toLong(v1) - toLong(v2));
  }
