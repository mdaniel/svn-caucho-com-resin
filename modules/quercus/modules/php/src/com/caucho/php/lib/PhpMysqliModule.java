 ...
 * PHP mysql routines.
 */
public class PhpMysqliModule extends AbstractPhpModule {
  private static final Logger log = Log.open(PhpMysqliModule.class);
  private static final L10N L = new L10N(PhpMysqliModule.class);
  ...
  public static Value mysqli_get_client_info(Env env)
    throws SQLException
  {
    JdbcConnectionResource conn = PhpMysqliModule.getConnection(env, null);
   ...
   */
    ...
    throws SQLException
   {
     ...
     if (conn == null)
       ...
       return new LongValue(PhpMysqliModule.infoToVersion(conn.getClientInfo()));
   }
    ...
    throws SQLException
  {
    if (connV == null)
      ...
      return new LongValue(PhpMysqliModule.infoToVersion(connV.getServerInfo()));
  }
  ...
  {
    return PhpMysqliModule.mysqli_store_result(conn);
  }
  ...
  {
    return PhpMysqliModule.mysqli_stmt_result_metadata(stmt);
  }
