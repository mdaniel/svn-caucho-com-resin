 ...
 */
public class PhpMailModule extends AbstractPhpModule {
  private static final Logger log =
    Logger.getLogger(PhpMailModule.class.getName());
  
  private static final L10N L = new L10N(PhpMailModule.class);
