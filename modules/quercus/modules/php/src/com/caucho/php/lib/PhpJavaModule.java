 ...
 * Java functions
 */
public class PhpJavaModule extends AbstractPhpModule {
  private static final Logger log =
    Logger.getLogger(PhpJavaModule.class.getName());
  
  private static final L10N L = new L10N(PhpJavaModule.class);
