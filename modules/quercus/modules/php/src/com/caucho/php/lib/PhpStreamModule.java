 ...
 */
public class PhpStreamModule extends AbstractPhpModule {
  private static final L10N L = new L10N(PhpStreamModule.class);
  private static final Logger log
    = Logger.getLogger(PhpStreamModule.class.getName());
  ...
  public Value stream_get_wrappers()
  {
    ...
    value.append(new StringValue("php"));
