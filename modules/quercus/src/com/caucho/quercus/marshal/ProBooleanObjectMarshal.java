...
public class ProBooleanObjectMarshal extends BooleanObjectMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProBooleanObjectMarshal();

  public void generate(PhpWriter out, ExprGenerator expr, Class argClass)
    throws IOException
  {
    expr.generate(out);
    out.print(".toJavaBoolean()");
  }
