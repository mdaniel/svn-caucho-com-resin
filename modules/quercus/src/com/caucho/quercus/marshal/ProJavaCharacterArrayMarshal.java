...
public class ProJavaCharacterArrayMarshal extends JavaCharacterArrayMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProJavaCharacterArrayMarshal();
  ...
  public void generateResultStart(PhpWriter out)
    throws IOException
  {
    out.print("new UnicodeBuilderValue((char[]) ");
  }
