...
public class ProJavaByteObjectArrayMarshal extends JavaByteObjectArrayMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProJavaByteObjectArrayMarshal();
    ...
    throws IOException
  {
    if (out.getPhp().isUnicodeSemantics())
      out.print("new BinaryBuilderValue((Byte[]) ");
    else
      out.print("new StringBuilderValue((Byte[]) ");
  }
