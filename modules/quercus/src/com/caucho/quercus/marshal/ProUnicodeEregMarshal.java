...
public class ProUnicodeEregMarshal extends UnicodeEregMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProUnicodeEregMarshal();
  
  public void generate(PhpWriter out, ExprGenerator expr, Class argClass)
    throws IOException
  {
    out.print("com.caucho.quercus.lib.regexp.RegexpModule.createUnicodeEreg(env, ");
