...
public class ProBinaryInputMarshal extends BinaryInputMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProBinaryInputMarshal();
  
  public void generate(PhpWriter out, ExprGenerator expr, Class argClass)
    throws IOException
  {
    out.print("com.caucho.quercus.marshal.BinaryInputMarshal.marshal(env, ");
