...
public class ProIntegerObjectMarshal extends IntegerObjectMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProIntegerObjectMarshal();

  public void generate(PhpWriter out, ExprGenerator expr, Class argClass)
    throws IOException
  {
    expr.generate(out);
    out.print(".toJavaInteger()");
  }
