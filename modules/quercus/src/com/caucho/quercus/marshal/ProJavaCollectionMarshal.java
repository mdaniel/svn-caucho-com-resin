 ...
 */
public class ProJavaCollectionMarshal extends JavaCollectionMarshal
  implements ProMarshal
{
  private static final L10N L = new L10N(JavaMarshal.class);

  public ProJavaCollectionMarshal(JavaClassDef def,
                      boolean isNotNull,
    ...
    throws IOException
  {
    ...
    expr.generate(out);
    out.print(".toJavaCollection(env, " + argClass.getName() + ".class)");
  }
