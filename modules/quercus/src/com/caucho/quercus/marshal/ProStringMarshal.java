...
public class ProStringMarshal extends StringMarshal
  implements ProMarshal
{
  public static final Marshal MARSHAL = new ProStringMarshal();
  
  public void generate(PhpWriter out, ExprGenerator expr, Class argClass)
    throws IOException
  {
    expr.generate(out);
    out.print(".toJavaString()");
  }
    ...
    throws IOException
  {
    if (out.getPhp().isUnicodeSemantics())
      out.print("UnicodeBuilderValue.create( ");
    else
