 ...
 */
public class ConditionalShortExprPro extends ConditionalShortExpr
  implements ExprPro
{
  public ConditionalShortExprPro(Expr test, Expr falseExpr)
  {
  ...
  private ExprGenerator GENERATOR = new ExprGenerator(getLocation()) {
      ...
      {
        if (_tempVar == null)
          _tempVar = info.getFunction().createTempVar();
