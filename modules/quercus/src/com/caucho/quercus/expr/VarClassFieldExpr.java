 ...
 */
public class VarClassFieldExpr extends AbstractVarExpr {
  private static final L10N L = new L10N(VarClassFieldExpr.class);

  protected final Expr _className;
  protected final String _varName;

  public VarClassFieldExpr(Expr className, String varName)
  {
