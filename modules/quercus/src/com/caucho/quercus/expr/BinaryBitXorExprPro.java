 ...
 */
public class BinaryBitXorExprPro extends BinaryBitXorExpr
  implements ExprPro
{
  public BinaryBitXorExprPro(Expr left, Expr right)
  {
    super(left, right);
  }
  ...
  private ExprGenerator GENERATOR = new AbstractBinaryGenerateExpr(getLocation()) {
	...
	throws IOException
      {
	out.print("new com.caucho.quercus.expr.BitXorExpr(");
