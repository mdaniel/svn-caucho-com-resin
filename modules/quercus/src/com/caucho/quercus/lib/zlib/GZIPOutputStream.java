...
public class GZIPOutputStream extends DeflaterOutputStream
{
  ...
  private byte[] _header = { (byte)0x1f, (byte)0x8b,  //gzip file identifier (ID1, ID2)
   ...
   * @param def
   */
  private GZIPOutputStream(OutputStream out,
                                                 Deflater def)
    throws IOException
  {
    super(out, def);
  ...
  public GZIPOutputStream(OutputStream out,
    ...
    throws IOException
  {
    this(out, new Deflater(compressionLevel, (encodingMode==ZlibModule.FORCE_GZIP)));
  ...
  {
    super.write(input);
    if (_encodingMode == ZlibModule.FORCE_GZIP)
      _crc32.update(input);
  }
  ...
  public void write(byte[] input, int offset, int length)
    throws IOException
  {
    super.write(input, offset, length);
    if (_encodingMode == ZlibModule.FORCE_GZIP)
