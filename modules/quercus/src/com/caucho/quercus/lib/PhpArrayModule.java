 ...
 * PHP array routines.
 */
public class PhpArrayModule extends AbstractPhpModule {
  private static final L10N L = new L10N(PhpArrayModule.class);
  
  private static final Logger log = 
    Logger.getLogger(PhpArrayModule.class.getName());
