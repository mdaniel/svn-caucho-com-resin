...
import com.caucho.php.env.OutputBuffer;
 ...
 * PHP output routines.
 */
public class PhpOutputModule extends AbstractPhpModule {
  private static final L10N L = new L10N(PhpOutputModule.class);
  private static final Logger log
    = Logger.getLogger(PhpOutputModule.class.getName());
