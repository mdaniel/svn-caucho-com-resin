...
public class Mcrypt {
  ...
  public int get_key_size()
  {
    if (QuercusMcryptModule.MCRYPT_RIJNDAEL_128.equals(_algorithm))
      ...
      return 24;
    else if (QuercusMcryptModule.MCRYPT_BLOWFISH.equals(_algorithm))
      return 56;
    else
  ...
  {
    return (QuercusMcryptModule.MCRYPT_DES.equals(_algorithm) ||
	    QuercusMcryptModule.MCRYPT_3DES.equals(_algorithm));
  }
    ...
    throws Exception
  {
    ...
    if (QuercusMcryptModule.MCRYPT_RIJNDAEL_128.equals(algorithm))
      return "AES/" + mode + "/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_RIJNDAEL_192.equals(algorithm))
      return "AES/" + mode + "192/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_RIJNDAEL_256.equals(algorithm))
      return "AES/" + mode + "256/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_DES.equals(algorithm))
      return "DES/" + mode + "/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_3DES.equals(algorithm))
      return "DESede/" + mode + "/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_BLOWFISH.equals(algorithm))
      return "Blowfish/" + mode + "/NoPadding";
    else if (QuercusMcryptModule.MCRYPT_ARCFOUR.equals(algorithm) ||
	     QuercusMcryptModule.MCRYPT_RC4.equals(algorithm))
  ...
  {
    if (QuercusMcryptModule.MCRYPT_RIJNDAEL_128.equals(algorithm) ||
	QuercusMcryptModule.MCRYPT_RIJNDAEL_192.equals(algorithm) ||
	QuercusMcryptModule.MCRYPT_RIJNDAEL_256.equals(algorithm))
      return "AES";
    else if (QuercusMcryptModule.MCRYPT_3DES.equals(algorithm))
      return "DESede";
    else
