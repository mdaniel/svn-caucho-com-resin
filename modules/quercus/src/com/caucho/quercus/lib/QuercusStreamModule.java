 ...
 */
public class QuercusStreamModule extends AbstractQuercusModule {
  private static final L10N L = new L10N(QuercusStreamModule.class);
  private static final Logger log
    = Logger.getLogger(QuercusStreamModule.class.getName());
