 ...
 */
public class QuercusHtmlModule extends AbstractQuercusModule {
  private static final L10N L = new L10N(QuercusHtmlModule.class);
                                          ...
                                          @Optional("ENT_COMPAT") int quoteStyle)
  {
    ...
    if ((quoteStyle & ENT_HTML_QUOTE_SINGLE) != 0)
      result.put(new StringValue("'"), new StringValue("&apos;"));
