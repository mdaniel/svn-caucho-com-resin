 ...
 * Java functions
 */
public class QuercusJavaModule extends AbstractQuercusModule {
  private static final Logger log =
    Logger.getLogger(QuercusJavaModule.class.getName());

  private static final L10N L = new L10N(QuercusJavaModule.class);
