 ...
 */
public class StaticFieldRefExpr extends Expr {
  private static final L10N L = new L10N(StaticFieldRefExpr.class);

  private final String _className;
  private final String _varName;
  private final String _envName;

  public StaticFieldRefExpr(String className, String varName)
  {
  ...
  public Value eval(Env env)
    throws Throwable
  {
    return env.getGlobalVar(_envName).toRef();
  }
