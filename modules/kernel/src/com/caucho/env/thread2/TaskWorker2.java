 ...
 */
abstract public class TaskWorker2 extends AbstractTaskWorker2 {
  private final ThreadPool2 _threadPool;
  // private final ThreadRing _threadRing;

  protected TaskWorker2()
  {
    super(Thread.currentThread().getContextClassLoader());
    
    _threadPool = ThreadPool2.getCurrent();
