...
public class CustomBeanArgAttribute extends Attribute {
  private static final L10N L = new L10N(CustomBeanArgAttribute.class);

  private final ConfigType _configType;

  public CustomBeanArgAttribute(Class cl)
  {
