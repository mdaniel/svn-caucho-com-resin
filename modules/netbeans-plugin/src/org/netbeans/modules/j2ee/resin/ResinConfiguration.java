...
public class ResinConfiguration implements DeploymentConfiguration, XpathListener
{
  private static final Logger log = Logger.getLogger(ResinConfiguration.class.getName());
  ...
  public void init(File file)
  {
    try
    {
      ...
      try
      {
        ...
        pw.println("<ResinServer path=\"/resin\"/>"); // NOI18N
      }
      finally
      {
        if (pw != null)
  ...
  public void fireXpathEvent(XpathEvent xpe)
  {
    ...
    if ("/web-app/resource-ref".equals(eventDDBean.getXpath()))
    { // NIO18N
