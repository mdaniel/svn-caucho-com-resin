...
public class ResinOptionalDeploymentManagerFactory extends OptionalDeploymentManagerFactory
{
  private static final Logger log = Logger.getLogger(ResinOptionalDeploymentManagerFactory.class.getName());

  
  public StartServer getStartServer(DeploymentManager dm)
  {
    return new ResinStartServer();
  }
  ...
  {
    return new ResinInstantiatingIterator();
  }
}