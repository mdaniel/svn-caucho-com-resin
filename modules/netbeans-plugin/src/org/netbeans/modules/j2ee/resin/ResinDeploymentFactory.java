...
public class ResinDeploymentFactory implements DeploymentFactory
{
  private static final Logger log = Logger.getLogger(ResinDeploymentFactory.class.getName());
  ...
  {
    return NbBundle.getMessage(ResinDeploymentFactory.class, "TXT_DisplayName"); // NOI18N
  }
}