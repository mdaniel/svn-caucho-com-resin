...
public class ResinInstantiatingIterator implements WizardDescriptor.InstantiatingIterator
{
  private static final Logger log = Logger.getLogger(ResinInstantiatingIterator.class.getName());
  ...
  public String name()
  {
    return NbBundle.getMessage(ResinInstantiatingIterator.class, "MSG_InstallerName");
  }
  ...
  public Set instantiate() throws IOException
  {
    ...
    String url         = "deployer:resin:localhost:8080"; // NOI18N
    ...
    catch (Exception ex)
    {
      DialogDisplayer.getDefault().notify(new NotifyDescriptor.Message(
              NbBundle.getMessage(ResinInstantiatingIterator.class, "MSG_CreateFailed", displayName),
