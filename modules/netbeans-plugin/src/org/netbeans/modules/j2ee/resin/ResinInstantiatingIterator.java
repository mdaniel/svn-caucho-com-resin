...
public class ResinInstantiatingIterator
  implements WizardDescriptor.InstantiatingIterator
{
  ...
  public String name()
  {
    return NbBundle.getMessage(ResinInstantiatingIterator.class,
                               "MSG_InstallerName");
  }
    ...
    throws IOException
  {
    ...
    try {
      ...
      DialogDisplayer.getDefault().notify(new NotifyDescriptor.Message(
        NbBundle.getMessage(ResinInstantiatingIterator.class,
                            "MSG_CreateFailed",
                            displayName),
  ...
  private static class InstallPanel
