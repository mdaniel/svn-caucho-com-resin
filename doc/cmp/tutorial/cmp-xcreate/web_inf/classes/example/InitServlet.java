...
public class InitServlet extends HttpServlet {
    ...
    throws ServletException
  {
	...
	ResultSet rs = stmt.executeQuery("SELECT course_id FROM xcreate_courses");
	...
	stmt.executeUpdate("INSERT INTO xcreate_courses VALUES('Potions', 'Severus Snape')");
	stmt.executeUpdate("INSERT INTO xcreate_courses VALUES('Transfiguration', 'Minerva McGonagall')");
	stmt.executeUpdate("INSERT INTO xcreate_courses VALUES('Defense Against the Dark Arts', 'Remus Lupin')");
