...
public class InitServlet extends HttpServlet {
    ...
    throws ServletException
  {
	...
	ResultSet rs = stmt.executeQuery("SELECT * FROM find_courses");
	...
	stmt.executeUpdate("INSERT INTO find_courses VALUES('Potions', 'Severus Snape')");
	stmt.executeUpdate("INSERT INTO find_courses VALUES('Transfiguration', 'Minerva McGonagall')");
	stmt.executeUpdate("INSERT INTO find_courses VALUES('Defense Against the Dark Arts', 'Remus Lupin')");
