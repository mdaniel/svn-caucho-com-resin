...
public class InitServlet extends HttpServlet {
    ...
    throws ServletException
  {
	...
	ResultSet rs = stmt.executeQuery("SELECT id FROM xbasic_courses");
	...
	stmt.executeUpdate("INSERT INTO xbasic_courses VALUES ('Potions', 'Severus Snape')");
	stmt.executeUpdate("INSERT INTO xbasic_courses VALUES ('Transfiguration', 'Minerva McGonagall')");
