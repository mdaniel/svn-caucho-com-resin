...
public class InitServlet extends HttpServlet {
    ...
    throws ServletException
  {
	...
	ResultSet rs = stmt.executeQuery("SELECT course_id FROM create_courses");
	...
	stmt.executeUpdate("INSERT INTO create_courses VALUES('Potions', 'Severus Snape')");
	stmt.executeUpdate("INSERT INTO create_courses VALUES('Transfiguration', 'Minerva McGonagall')");
	stmt.executeUpdate("INSERT INTO create_courses VALUES('Defense Against the Dark Arts', 'Remus Lupin')");
