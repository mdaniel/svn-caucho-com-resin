...
public class InitServlet extends HttpServlet {
    ...
    throws ServletException
  {
	...
	ResultSet rs = stmt.executeQuery("SELECT id FROM find_xcourses");
	...
	stmt.executeUpdate("INSERT INTO find_xcourses VALUES('Potions', 'Severus Snape')");
	stmt.executeUpdate("INSERT INTO find_xcourses VALUES('Transfiguration', 'Minerva McGonagall')");
	stmt.executeUpdate("INSERT INTO find_xcourses VALUES('Defense Against the Dark Arts', 'Remus Lupin')");
