...
public class StartAction extends NodeAction {
  ...
  private static StartAction instance;

  public static StartAction getInstance() {
    if (instance == null) {
      instance = new StartAction();
    }
  ...
  public String getName() {
    return NbBundle.getMessage(ViewServerLogAction.class, "start-resin");
  }
