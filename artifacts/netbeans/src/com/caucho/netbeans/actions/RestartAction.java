...
public class RestartAction extends NodeAction {
  ...
  private static RestartAction instance;

  public static RestartAction getInstance() {
    if (instance == null) {
      instance = new RestartAction();
    }
  ...
  public String getName() {
    return NbBundle.getMessage(ViewServerLogAction.class, "restart-resin");
  }
