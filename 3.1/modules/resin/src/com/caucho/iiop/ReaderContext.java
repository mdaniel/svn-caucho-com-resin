...
public final class ReaderContext
{
  ...
  {
    return _savedStrings.get(offset);
  }

  public void putString(int offset, String value)
  {
    _savedStrings.put(offset, value);
  }

  public void addRef(int offset, Serializable value)
  {
    _refOffsets.add(offset);
    _refValues.add(value);
  }

  public Serializable getRef(int offset)
  {
    int len = _refOffsets.size();
