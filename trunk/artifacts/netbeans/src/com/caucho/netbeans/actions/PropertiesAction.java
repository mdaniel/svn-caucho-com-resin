...
public class PropertiesAction extends NodeAction {
  ...
  private static PropertiesAction instance;

  public static PropertiesAction getInstance() {
    if (instance == null) {
      instance = new PropertiesAction();
    }
  ...
  protected void performAction(Node[] nodes) {
    ...
    CommonServerUIs.showCustomizer(resin.getResinServerInstance().getServerInstance());
  }
  ...
  public String getName() {
    return NbBundle.getMessage(ViewServerLogAction.class, "edit-resin-properties");
  }
