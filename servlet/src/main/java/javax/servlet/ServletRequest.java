...
public interface ServletRequest {
   ...
   * correct call for forming urls, but may not contain the host the server is
   ...
   * if ipchains, load balancing, or proxying is involved this call returns the
   * correct call for forming urls, but may not return the actual port the
  ...
  /**
   * This call returns the ip of the host actually used to connect to the
   ...
   * server,  which means that if ipchains, load balancing, or proxying
   ...
   *
   * This call returns the port number actually used to connect to the
   * server,  which means that if ipchains, load balancing, or proxying is
